        ...
        >
          ...
          <div className="relative w-full h-full flex items-center justify-center px-4 py-32 md:py-40 mt-24 z-10">
            <div className="max-w-4xl w-full mx-auto text-center">
              <h1 className="text-2xl sm:text-3xl md:text-5xl lg:text-6xl subtitle text-metallic-gold mb-12 mx-auto max-w-3xl font-black leading-tight hero-title">
                Unleash Your Inner Warrior - Your Next Battle Mark Awaits
              </h1>
              <p className="text-lg sm:text-xl md:text-3xl lg:text-4xl font-black animate-fade-in text-gray-100 leading-tight mb-6">
